...
for x in xrange(len(passwords)):
    ...
    pos1 = int(currPassword[ : currPassword.index("-")]) - 1
    pos2 = int(currPassword[currPassword.index("-")+1 : currPassword.index(":")-2]) - 1
    char = currPassword[currPassword.index(" ")+1 : currPassword.index(":")]
    password = currPassword[currPassword.index(":")+2:]
    print(password)
    print("pos1 =", pos1)
    print("pos2 =", pos2)
    print("char =", char)
